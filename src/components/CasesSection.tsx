const cases = [
  {
    ...
    image: "https://images.unsplash.com/photo-1758691462878-6edc3d3da1be?w=600&q=80&auto=format&fit=crop",
    tags: ["React", "Tailwind", "TypeScript", "Java", "Spring", "PostgreSQL", "Docker", "DBeaver"],
    url: "", // Cole aqui o link do projeto quando tiver (ex: "https://...")
  },
  {
    id: "venda-cursos",
    title: "Site de Venda de Cursos",
    image: "https://picsum.photos/seed/cursos/600/360",
    tags: ["HTML", "CSS", "JavaScript", "Tailwind", "Java", "Spring Boot", "Lombok", "PostgreSQL", "DBeaver", "Docker"],
    url: "", // Cole aqui o link do projeto quando tiver (ex: "https://...")
  },
]
          ...
          {cases.map((project) => {
            ...
            const wrapperProps = project.url
              ? {
                  ...
                  className:
                    "group relative rounded-2xl border border-zinc-800/50 bg-zinc-900/30 backdrop-blur-sm overflow-hidden hover:border-blue-500/30 hover:bg-zinc-900/50 transition-all duration-300 block focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 cursor-pointer",
                }
              : {
                  className:
                    "group relative rounded-2xl border border-zinc-800/50 bg-zinc-900/30 backdrop-blur-sm overflow-hidden hover:border-blue-500/30 hover:bg-zinc-900/50 transition-all duration-300",
                }
            return (
